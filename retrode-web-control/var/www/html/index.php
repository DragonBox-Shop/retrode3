...
if($slot=getvar('slot'))
	...
	echo " ...done.</p>";
	flush();
	// needs some logic and scanning the result to find out what the real file name is...
	// ... that was assigned by oscr
	$name=getvar('slot');
	// this is a hack since it mixes /dev/slot names with names generated by oscr
	$name=strtoupper($name);
	// the best solution would be if retrode-read knows about these details and filters and generates the file name
	weblink("Show File", "files.php?file=oscr/$name");
	}
